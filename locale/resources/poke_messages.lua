return 
{
    ...
    "a vegan membership card",
    "an orphan underground pipe",
    "unrequited patriotism",
    "a Zimbabwe 100 trillion dollar note",
    "the 0.17 patch notes",
    "an undocumented assault weapon",
    "a discord invite",
    "a MLP doll",
    "a dakimakura",
    "a giftcard to Bad Dragon",
    "a broken HD that once contained a bitcoin wallet"
}